...
As discussed at length in section 2.5, altmetrics provide a faster, more diverse and transparent mechanism for measuring scholarly impact.
...
As is evident from the aim of this project, more study of altmetrics is required. The literature review found several potential topics for this research (see section 2.5.1). This includes data source categorisation, network effects, alternative scholarly output and the temporal aspect of altmetrics. In addition, many of the criticisms levelled at altmetrics (see section 2.4) can be answered through more research. For example, gathering more evidence of correlation with citation counts or investigating methods for reducing gaming.
