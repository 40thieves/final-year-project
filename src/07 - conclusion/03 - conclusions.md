...
Another area for future work is the development of a trace line - a line that is drawn as the article bubble progresses through time. Time constraints lead to development of this feature to be stopped, however it would add significantly to the usability of the graph.
